...
function parse(json) {
  ...
  for (let target of Object.keys(json.targets)) {
    targets[target] = _buildSettings2.default.fromJSON(json.targets[target]);
  }
...
class Artifacts {
  ...
  constructor() {
    let active = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    let targets = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  save(file) {
    (0, _fs.writeFileSync)(file, JSON.stringify(this.toJSON()));
  }
